...
SELECT
	...
	r.LGNAME,
	r.LGPRC,
	SUM(CASE WHEN r.LGCODE = 504 THEN r.SUMM ELSE 0 end) woz,
	SUM(CASE WHEN r.LGCODE = 514 THEN r.SUMM ELSE 0 end) z1,
	SUM(CASE WHEN r.LGCODE = 524 THEN r.SUMM ELSE 0 end) z2,
	SUM(CASE WHEN r.LGCODE = 532 THEN r.SUMM ELSE 0 end) z3,
	SUM(CASE WHEN r.LGCODE = 508 THEN r.SUMM ELSE 0 end) z4,
	SUM(CASE WHEN r.LGCODE = 504 THEN r.FACT ELSE 0 end) wozKwt,
	SUM(CASE WHEN r.LGCODE = 514 THEN r.FACT ELSE 0 end) z1Kwt,
	SUM(CASE WHEN r.LGCODE = 524 THEN r.FACT ELSE 0 end) z2Kwt,
	SUM(CASE WHEN r.LGCODE = 532 THEN r.FACT ELSE 0 end) z3Kwt,
	SUM(CASE WHEN r.LGCODE = 508 THEN r.FACT ELSE 0 end) z4Kwt,
	r.NasPunkt,
	r.VulName,
	r.Bild,
	r.Korp,
